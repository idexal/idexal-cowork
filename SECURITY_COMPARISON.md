...
When choosing a self-hosted AI assistant platform, security should be a primary concern. This document outlines key security considerations and how idexal CoWork addresses them.
...
| Feature | Important For | idexal CoWork |
|---------|---------------|------------|
...
If you discover a security vulnerability in idexal CoWork:

1. **Do NOT** report via public GitHub issues
2. Use GitHub Security Advisories (preferred)
3. Or email: info@cowork.idexal.com
