...
description: How idexal CoWork positions Workflow Intelligence and its reflective learning stack against adjacent agent ecosystems.
---

# Reflective Learning Systems

This page focuses on the learning-system shape that matters for idexal CoWork today: durable local memory, explicit reflective artifacts, target-scoped backlog, and executor dispatch.

## idexal CoWork Positioning

idexal CoWork combines two layers:
