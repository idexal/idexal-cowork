...
Pack and skill toggle states are persisted in `pack-states.json` in the user data directory (`~/Library/Application Support/idexal/`). The file uses the following format:
