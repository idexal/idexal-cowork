...
- **App branding**: macOS app/Dock icons and dark-mode renderer assets now use `resources/branding/idexal-cowork-app-logo-dark.png`; Windows and light-mode renderer assets use `resources/branding/idexal-cowork-app-logo-light.png`.
